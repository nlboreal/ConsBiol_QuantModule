...
2. A short document that answers all the questions posed throughout this assignment (they are all shown in italics)

3. Copies of the final version of all plots created (remember you can export these as image files from the "Plots" pane in R Studio which you can then paste in Word). Convert the Word document to a PDF file and upload it to the Dropbox folder in Brightspace. 
